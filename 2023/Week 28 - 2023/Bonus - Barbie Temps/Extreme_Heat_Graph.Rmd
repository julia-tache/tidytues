...
ggplot() +
  ...
  geom_line(data = global_temps_graph, aes(x = factor(Month, levels = unique(Month)), y = `Temp Change`, group = Year), color = "gray") + 
  ...
  annotate("text", x = 6, y = 1, label = "May, 2023" , fontface = "bold", color = dark_color_barbie, size = 8) +
  annotate("text", x = 8, y = -0.4, label = "Rising temperatures mean deviations from normal temps are becoming more extreme." , fontface = "italic", color = dark_color_barbie, size = 6) +
  ylim(-0.5, 1.5) +
