...
bargraph1 <- ggplot(global_temps_bargraph, aes(x = Year, y = `J-D`)) +
  ...
  labs(subtitle = 'The change in global surface temperature (combined land-surface, air-, and sea-surface\nwater temperatures) has been increasing year-to-year since the 1980s.\n\nTemperature anomalies indicate how much warmer or colder it is than "normal" for a particular\nplace and time (normal = average over 30-year period of 1951-1980).',
